...
int main()
{
	...
	strcpy(stu[0].student_id,"210911374");
	strcpy(stu[1].student_id,"210911378");
	...
	strcpy(stu[0].fname,"AVIRAL");
	strcpy(stu[1].fname,"YASH");
	strcpy(stu[0].lname,"MALIK");
	strcpy(stu[1].lname,"YASHKARAM");
